...
const db = {
  ...
  appointments: [
    // ===== Centro Médico San Martín =====
    { id: 'apt-csm-1', cuentaId: CSM, profesionalId: 'prof-funes', serviceName: 'Consulta Psicológica', patientName: 'Romina Ferreyra', patientEmail: 'rominaferreyra84@gmail.com', patientPhone: '1160254871', patientDni: '31485296', date: fechaLocal(-3), time: '15:00', status: 'ATTENDED', notes: 'Sesión de seguimiento.', location: 'Centro Médico San Martín', healthInsurance: 'OSECAC' },
    { id: 'apt-csm-2', cuentaId: CSM, profesionalId: 'prof-rios', serviceName: 'Limpieza Dental', patientName: 'Hugo Benítez', patientEmail: 'hbenitez1958@hotmail.com', patientPhone: '1144762903', patientDni: '12958374', date: fechaLocal(-2), time: '09:30', status: 'ATTENDED', notes: 'Paciente de PAMI, trae orden.', location: 'Centro Médico San Martín', healthInsurance: 'PAMI' },
    { id: 'apt-csm-3', cuentaId: CSM, serieId: 'serie-kine-acosta', profesionalId: 'prof-vega', serviceName: 'Sesión de Kinesiología', patientName: 'Federico Acosta', patientEmail: 'fedeacosta92@gmail.com', patientPhone: '1157983041', patientDni: '36741852', date: fechaLocal(-1), time: '09:00', status: 'ATTENDED', notes: 'Post-quirúrgico LCA, sesión 6 de 12.', location: 'Centro Médico San Martín', healthInsurance: 'OSDE' },
    ...
    { id: 'apt-csm-16', cuentaId: CSM, serieId: 'serie-kine-acosta', profesionalId: 'prof-vega', serviceName: 'Sesión de Kinesiología', patientName: 'Federico Acosta', patientEmail: 'fedeacosta92@gmail.com', patientPhone: '1157983041', patientDni: '36741852', date: fechaLocal(8), time: '09:00', status: 'CONFIRMED', notes: 'Post-quirúrgico LCA, sesión 8 de 12. [Serie: sesión de 4]', location: 'Centro Médico San Martín', healthInsurance: 'OSDE' },
    { id: 'apt-csm-17', cuentaId: CSM, serieId: 'serie-kine-acosta', profesionalId: 'prof-vega', serviceName: 'Sesión de Kinesiología', patientName: 'Federico Acosta', patientEmail: 'fedeacosta92@gmail.com', patientPhone: '1157983041', patientDni: '36741852', date: fechaLocal(15), time: '09:00', status: 'PENDING', notes: 'Post-quirúrgico LCA, sesión 9 de 12. [Serie: sesión de 4]', location: 'Centro Médico San Martín', healthInsurance: 'OSDE' },
